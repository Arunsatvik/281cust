...
import Logo from '../../assets/coffeerobo.jpeg';
    ...
    <div className='home__base'>
      { this.state.isOrder?
        <div className='order__done__box'> 
          <div className='done'> {this.state.comment} </div> <br></br>
          <div className='done'> OrderID : {this.state.orderID} </div>
          <div className='done'> Location: {this.state.address} </div>
          <div className='done'> Type: {this.state.type} </div>
          <div className='done'> Size: {this.state.size} </div>
        </div>
        :
        <div>
        <div>
          <h2 className='welcome__text'> Place Your Coffee Order </h2>
